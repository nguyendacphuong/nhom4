<div class="slider-wrap">
    <div class="fullwidthbanner-container">
        <div class="fullwidthbanner">
            <ul>
                <li data-transition="parallaxtoright,parallaxtoleft" data-slotamount="7" data-masterspeed="600" data-saveperformance="off"> <img src="<?= CLIENT_ASSET ?>img/slider/slider-1/slider1.jpg" alt="banner_slider02" data-bgposition="left bottom" data-bgfit="cover" data-bgrepeat="no-repeat">
                    ...
                    <div class="tp-caption customin" data-x="300" data-y="200" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:2;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-speed="1000" data-start="2000" data-easing="easeInOutExpo" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="z-index: 6;"><img src="<?= CLIENT_ASSET ?>img/slider/slider-1/slider-text-2.png" alt="">
                    </div>
                    <div class="tp-caption small_text customin tp-resizeme" data-x="300" data-y="300" data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:2;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-speed="1000" data-start="2500" data-easing="easeInOutExpo" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="z-index: 7; max-width: 742px; max-height: 60px; white-space: normal;">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                    </div>
                    <div class="tp-caption randomrotate" data-x="299" data-y="400" data-speed="1000" data-start="3000" data-easing="Power3.easeInOut" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="z-index: 8;"><a href="#"><img src="<?= CLIENT_ASSET ?>img/slider/slider-1/slider-text-4.png" alt=""></a>
                    </div>
                </li>
                                ...
                                <div class="features-curosel">
                                    ...
                                    <div class="col-12">
                                        <div class="single-product">
                                            ...
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image" src="<?= CLIENT_ASSET ?>img/product/7.jpg" alt="" />
                                                    <img class="secondary-image" src="<?= CLIENT_ASSET ?>img/product/8.jpg" alt="" />
                                                </a>
                                                <div class="actions">
                                                    <div class="action-buttons">
                                                        <div class="add-to-cart">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-img">
                                                <a href="#">
                                                    ...
                                                    <img class="secondary-image" src="<?= CLIENT_ASSET ?>img/product/13.jpg" alt="" />
                                                </a>
                                                <div class="actions">
                                                    <div class="action-buttons">
                                                        <div class="add-to-cart">
