                ...
                <form action="<?= ADMIN_URL . 'sanpham/update' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-6 offset-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="<?php echo $lis['title']; ?> " class="form-control" placeholder="Yêu cầu nhập tên sản phẩm" aria-describedby="helpId" required>
                        </div>
                        <div class="form-group">
                            <label for="">Giá sản phẩm</label>
                            <input type="text" name="price" value="<?php echo $lis['price']; ?> " class="form-control" placeholder="yêu cầu nhập giá gốc" aria-describedby="helpId" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" value="" class="form-control" placeholder="yêu cầu nhập mô tả" aria-describedby="helpId" id="" cols="30" rows="10" required><?php echo $lis['description']; ?> </textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Số lượng</label>
                            <input type="text" name="number" value="<?php echo $lis['number']; ?> " class="form-control" placeholder="yêu cầu nhập số lượng" aria-describedby="helpId" required>
                        </div>
                        <br>
                        <div class="form-group">
